...
def train():
    ...
    # Sparse views
    parser.add_argument("--sparse_views", 
                        action="store_true",
    ...
    parser.add_argument("--label_map_ids", 
                        nargs="*", 
                        type=int, 
                        default=[],
    ...
    parser.add_argument("--random_sample", 
                        action="store_true", 
                        help="Whether to randomly or evenly sample frames from the sequence.")

    # Denoising - Pixel-wise
    parser.add_argument("--pixel_denoising", 
                        action="store_true",
                        help="Whether to work on pixel-denoising.")

    parser.add_argument("--pixel_noise_ratio",
                        type=float, 
                        default=0,
                        help="In sparse view mode, if pixel_noise_ratio > 0, the percentage of pixels to be perturbed in each sampled frame  for pixel-wise denoising.")
                        
    # Denoising - Region-wise
    parser.add_argument("--region_denoising", 
                        action="store_true",
                        help="Whether to work in region-denoising tasks by flipping class labels of chair instances in Replica Room_2")

    parser.add_argument("--region_noise_ratio", 
                        type=float, 
                        default=0,
                        help="In region-wise denoising task, region_noise_ratio is the percentage of chair instances to be perturbed in each sampled frame for region-wise denoising.")
    
    parser.add_argument("--uniform_flip", 
                        action="store_true",
    ...
    # Super-Resolution -> Image Upscaling and Sharpening 
    parser.add_argument("--super_resolution", 
                        action="store_true",
                        help="Set to render synthetic data on a white bkgd (always use for dvoxels).")

    parser.add_argument("--dense_sr",  
                        action="store_true", 
                        help="Whether to use dense or sparse labels for Super-Resolution instead of dense labels.")

    parser.add_argument("--sr_factor",  
                        type=int, 
                        default=8, 
                        help="Scaling factor of Super-Resolution.")
    ...
    parser.add_argument("--partial_perc", 
                        type=float,
                        default=0,
